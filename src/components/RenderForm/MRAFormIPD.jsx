        ...
        <View style={[tw("relative mt-1 flex flex-row gap-5"), { lineHeight: 0.9 }]}>
          ...
          <View style={[tw("text-xl flex"), { lineHeight: 0.9 }]}>
            <View style={[tw("relative"), { lineHeight: 0.9 }]}>
              ...
              {form_ipd_overall_finding_results?.find(x => x.overall_finding?.priority === 1)?.overall_finding_result && (
            ...
            <View style={[tw("relative"), { lineHeight: 0.9 }]}>
              ...
              {form_ipd_overall_finding_results?.find(x => x.overall_finding?.priority === 2)?.overall_finding_result && (
                <Svg style={[tw("absolute"), { lineHeight: 0.9, top: 2, left: 2.5 }]} width="12" height="12" viewBox="0 0 24 24">
                  <Path
                    d="M20.285 2.715L9 14l-5.285-5.285L2 10.43 9 17.43l13-13z"
                    fill="black"
            ...
            <View style={[tw("flex flex-row gap-2 pl-[3.2rem]"), { lineHeight: 0.9 }]}>
              ...
              <View style={[tw("flex"), { lineHeight: 0.9 }]}>
                <View style={[tw("relative"), { lineHeight: 0.9 }]}>
                  ...
                  {form_ipd_review_status_results?.find(x => x.review_status?.priority === 1)?.review_status_result && (
                    <Svg style={[tw("absolute"), { lineHeight: 0.9, top: 2, left: 2.5 }]} width="12" height="12" viewBox="0 0 24 24">
                      <Path
                        d="M20.285 2.715L9 14l-5.285-5.285L2 10.43 9 17.43l13-13z"
                        fill="black"
                ...
                <View style={[tw("relative"), { lineHeight: 0.9 }]}>
                  ...
                  {form_ipd_review_status_results?.find(x => x.review_status?.priority === 2)?.review_status_result && (
                    <Svg style={[tw("absolute"), { lineHeight: 0.9, top: 2, left: 2.5 }]} width="12" height="12" viewBox="0 0 24 24">
                      <Path
                        d="M20.285 2.715L9 14l-5.285-5.285L2 10.43 9 17.43l13-13z"
                        fill="black"
                ...
                <View style={[tw("relative"), { lineHeight: 0.9 }]}>
                  ...
                  {form_ipd_review_status_results?.find(x => x.review_status?.priority === 3)?.review_status_result && (
                    <Svg style={[tw("absolute"), { lineHeight: 0.9, top: 2, left: 2.5 }]} width="12" height="12" viewBox="0 0 24 24">
                      <Path
                        d="M20.285 2.715L9 14l-5.285-5.285L2 10.43 9 17.43l13-13z"
                        fill="black"
